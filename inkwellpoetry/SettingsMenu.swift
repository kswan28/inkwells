    ...
    var body: some View {
        ...
        HStack(spacing: 8){
            ...
            .sheet(isPresented: Binding(
                ...
                TextModalComponent(modalTitle: "About this app", modalHeaderIcon: "doc.questionmark", modalHeading1: "What is the Inkwells app?", modalText1: "Inkwells are daily word puzzles that spark your creativity and make writing easier.", modalHeading2: "Why did you create this app?", modalText2: "Words are magical. By putting words together in unexpected ways, it can bring joy, delight, and a bit of whimsy to your life.", modalHeading3: "What are the different puzzle styles?", modalText3: "The puzzle style you choose determines the words you get in your Inkwell. A classic puzzle style is standard words. A spooky puzzle style has words with ghosts, tricks, and treats. A swifty puzzle style makes you feel like you're writing songs with TayTay.", modalHeading4: "Who can see what I post?", modalText4: "Unless you choose to share a post, what you write is just for you. This app will store data either locally on your device or in iCloud (if you have iCloud turned on for the app). Your app data is not stored or shared anywhere else.", modalHeading5: "What happens if I delete this app?", modalText5: "If you have iCloud turned on for this app, your entries will be saved even if you delete the app and reinstall it later. However, if you're not using iCloud, all of your data will be deleted when you delete the app. This is by design -- you are fully in control of your poems.", modalHeading6: "Will this app work across all of my devices?", modalText6: "This app does have iCloud sync capabilities. If you turn on iCloud for this app, you'll be able to keep your great things in sync between any iOS devices using the same iCloud account.",modalHeading7: "Notifications aren't working.",modalText7:"Make sure notifications are turned on in your iOS app settings. For further help, contact us at tinyappsfeedback@gmail.com",modalHeading8: "When I try to give feedback or get help, the app asks me to restore the Mail App.",modalText8: "Sorry about that! The Inkwells App requires the Apple Mail client to send messages to the team. If you use another email client, that's no problem. You can drop us a note anytime at tinyappsfeedback@gmail.com.", modalHeading9: "Who made this app?", modalText9: "This app was made by Tiny App Studio, an organization that likes building software for humans. They were inspired to create the app because, well, they had writer's block a lot. This little game made it a bit better. The team sincerely hopes it makes your day a little easier or more expressive.",modalHeading10: "",modalText10: "",modalHeading11: "",modalText11: "")
