        ...
        HStack(spacing: 8){
            ...
            .sheet(isPresented: Binding(
                ...
                TextModalComponent(modalTitle: "Privacy policy & terms", modalHeaderIcon: "lock",
                                   ...
                                   modalText2: "This app uses services provided by Apple and Telemetry Deck to collect information and improve the app. This helps us understand how our users are using our app and how we can improve it. Personally identifiable information or user-entered data (like your Inkwells) are NOT collected.\n\nLottie Packages is used to deliver animations in the app and MijickPopupView customizes the pop-ups, but no data is collected by either service. All Lottie Animations and Mijick Pop-ups are used under license. Thank you to the talented animators and developers that shared their art to make this app a little better!\n\nAlso, thank you to sadgrlonline for sharing her magnetic-poetry project on github to make putting together my word lists a bit easier.",
